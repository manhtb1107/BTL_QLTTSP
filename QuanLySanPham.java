...
public class QuanLySanPham {
    ...
    public void luuFile() {
        try (ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream("src/sanphams.txt", true))) {
    ...
    public void docFile() {
        ...
        try (ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream("src/sanphams.txt" +
                ""))) {
            while (true) {
                try {
